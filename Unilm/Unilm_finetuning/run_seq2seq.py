...
def main():
    ...
    parser.add_argument("--src_file", default='finetune_data.csv', type=str,
    ...
    parser.add_argument("--config_name", default="model_dir/config.json", type=str,
                        help="Pretrained config name or path if not the same as model_name")
    parser.add_argument("--tokenizer_name", default="model_dir/vocab.txt", type=str,
    ...
    if args.do_train:
        ...
        bi_uni_pipeline = [utils_seq2seq.Preprocess4Seq2seq(args.max_pred,
                                                            args.mask_prob,
    ...
    # Prepare optimizer
    param_optimizer = list(model.named_parameters())  # 设置decay
        ...
        for i_epoch in trange(start_epoch, int(args.num_train_epochs) + 1, desc="Epoch",
            ...
            for step, batch in enumerate(iter_bar):
                ...
                if args.fp16:
                    ...
                    loss.backward()
                    torch.nn.utils.clip_grad_norm_(model.parameters(), args.max_grad_norm)  # clip norm
