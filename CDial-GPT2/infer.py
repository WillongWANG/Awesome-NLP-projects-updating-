...
def main():
    ...
    parser.add_argument("--datapath", type=str, default="data/STC_test.demo.json", help="Path of the dataset.")
    parser.add_argument("--out_path", type=str, default="STC_result.text", help="Path of response generated.")
    parser.add_argument("--model_checkpoint", type=str, default="thu-coai/CDial-GPT2_LCCC-base", help="Path, url or short name of the model")
